...
<head>
  ...
  <link rel="prev" href="/seaches">
  <link rel="next" href="/searches/3">
</head>
    ...
    <div class="contact-form__content">
      ...
      <div class="form__database-check">
        ...
        <nav class="pagination">
          <a href="/searches" class="pagination__prev" rel="prev">
            <span class="visuallyhidden">Previous Page</span>
          </a>
          <ul class="pagination__items">
            <li class="is-active"><a href="/searches" rel="prev">1</a></li>
            <li><a href="/seraches/2" class="link" remote="false">2</a></li>
            <li><a href="/searches/3" rel="next" class="link">3</a></li>
            <li><a href="/seraches/4" class="link">4</a></li>
          </ul>
          <a href="/seraches/3" class="pagination__next" rel="next">
      ...
      <table>
        ...
        <tr class="form__database-list">
            <td class="form__database-content">
              ...
              <label class="tooltip" for="swich">{{ $contact['option'] }}<span class="option:hover">{{ $contact['option'] }}</span></label>
              </p></td>
            <td class="form__database-content">
